...
import {
  Users, UserCheck, UserX, Home, Wifi, AlertTriangle,
  PlusCircle, CheckCircle, XCircle, MessageSquare, Eye, Clock, Brain,
  LayoutDashboard, ClipboardList, FileSearch
} from 'lucide-react';
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        {activeTab === 'tasks' && (
          <div className="space-y-4">
            {data.tasks.length === 0 && (
              <EmptyState title="No tasks assigned" description="Create a task for one of your students to get started." />
            )}
        ...
        {activeTab === 'evidence' && (
          <div className="space-y-4">
            {data.pendingEvidence.length === 0 && (
              <EmptyState title="No pending evidence" description="Student submissions awaiting review will appear here." />
            )}
